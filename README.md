...
🌐 [autotreehole.cn](https://autotreehole.cn)
...
在树洞，许多有意思的讨论转瞬即逝，许多有价值的信息没于汪洋。AutoTreehole 希望把这些散落的声音留存下来，让你不必成天刷着树洞也不会错过它们，也让那些值得被听见的声音能够被听见得更久一点。
...
| **MCP** | 生成个人 Token，让 Claude Code / Cursor / Codex 等 AI 助手直接查询树洞——你的智能体从此拥有对树洞的全局记忆（仅校园邮箱用户） |
| **关于** | 了解站点理念，或通过作者信箱留言 |
...
# 邮件服务（阿里云邮件推送 DirectMail，用于邮箱验证码与留言转发）
MAIL_USER=你的发信地址
MAIL_PASS=你的SMTP凭证
